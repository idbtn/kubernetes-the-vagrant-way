...
sudo kubeadm join loadbalancer1.idbtn.net:6443 --token $(cat ${token_path}) --discovery-token-ca-cert-hash sha256:$(cat ${ca_cert_hash_path}) --control-plane --certificate-key $(cat ${cert_key_path}) --apiserver-advertise-address "192.168.11.22"
